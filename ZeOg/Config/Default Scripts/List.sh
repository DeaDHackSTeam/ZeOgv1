...
echo [6]. Gmail/Outlook/Yahoo/AOL/GMX Account Cracker using THC-Hydra
echo [7]. 'Scan site/IP for ports/services/OS version using NMAP'
echo [8]. Info about a tool.
read -p "Choose an option?:" choice1

if [ $choice1 == 1 ]
then
  echo "${lightgreen}[+]launching shells...."
  exec /root/Desktop/ZeOg/Config/'Default Scripts'/AndroidRATmaker.sh
fi
if [ $choice1 == 2 ]
then
  echo "${lightgreen}[+]launching shells...."
  exec /root/Desktop/ZeOg/Config/'Default Scripts'/iOSRATmaker.sh
fi
if [ $choice1 == 3 ]
then
  echo "${lightgreen}[+]launching shells...."
  exec /root/Desktop/ZeOg/Config/'Default Scripts'/OSXRATmaker.sh
fi
if [ $choice1 == 4 ]
then
  exec /root/Desktop/ZeOg/Config/'Default Scripts'/LinuxRATmaker.sh
  echo "${lightgreen}[+]launching shells...."
fi
if [ $choice1 == 5 ]
then
  echo "${lightgreen}[+]launching shells...."
  exec /root/Desktop/ZeOg/Config/'Default Scripts'/WindowsRATmaker.sh
fi  
if [ $choice1 == 6 ]
then
  echo "${lightgreen}[+]launching shells...."
  exec /root/Desktop/ZeOg/Config/'Default Scripts'/EmailCracker.sh
fi
if [ $choice1 == 7 ]
then
  echo "${lightgreen}[+]launching shells...."
  exec /root/Desktop/ZeOg/Config/'Default Scripts'/IPSITEscanner.sh
fi  
if [ $choice1 == 8 ]
then
  exec /root/Desktop/ZeOg/Config/'Default Scripts'/Info-list.sh
  echo "${lightgreen}[+]launching shells...."
fi
clear
