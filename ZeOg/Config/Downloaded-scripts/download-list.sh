...
echo
echo
echo Choose any scripts you wanna to download:
echo
...
echo [3]. Ezsploit       Nearly undectable backdoors"
echo "${lightgreen}============ [ WiFi Hacking ] ===========
echo [4]. WiFi-Pumpkin   GUI interface WiFi Hacking
echo [5]. Morpheus       Ettercap hacking script
echo [6]. Fluxion        Best modern WiFi Cracking"
...
echo [11]. ReconDog      Many info gathering options
echo [12]. Sniper        Fast, accurate like a sniper oh and it get infos
echo [13]. Infoga        E-mail info gathering"
echo "${orange}========= [ Vulnerability Scanners ] =======
echo [14]. XAttacker     Many vulnerability scanners
echo [15]. SQLi scanner  SQL vulnerability scanner
echo [16]. a2vs          SSL vulenrability scanner
echo [17]. WPSeku        Many WordPress Scanner && auto exploiter"
